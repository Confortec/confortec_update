...
# ATENÇÃO: Use o link "Raw" para o TXT e o link de "Release" para o EXE
# Exemplo TXT (Raw): https://raw.githubusercontent.com/SeuUser/confortec-updates/main/version.txt
# OU Exemplo TXT (Release): https://github.com/SeuUser/confortec-updates/releases/download/v7.50/version.txt
...
class LauncherApp:
    ...
    def download_file(self, url, destination):
        # GitHub é simples: requests.get direto!
        response = requests.get(url, stream=True)
        response.raise_for_status() # Avisa se der erro 404 (Link errado)
